...
use crate::{Activity, Data, Entity, Group};
...
create_events!(Events:
    ...
    entity_removed { position_of_removed_entity: usize, name_of_removed_entity: &str },
    entity_renamed { entity: &Entity, old_name: &str },
