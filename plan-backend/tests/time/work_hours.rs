...
use test_utils::data_builder::{DataBuilder, Activity};
...
fn add_interals_check_sorted() {
    ...
    test_ok!(data, DataBuilder::new().with_work_intervals(vec![interval1, interval3, interval2]), {
...
fn update_time_interval_not_enough_time_for_activities() {
    ...
    test_err!(data, DataBuilder::new().with_work_interval(interval)
              .with_entity(entity)
              .with_activity(Activity{duration: Time::new(4, 0), 
              entities: vec![entity], ..Default::default()}), {
...
fn update_time_interval_overlaps() {
    ...
    test_err!(data, DataBuilder::new().with_work_intervals(vec![interval1, interval2]),
